...
export default function Footer() {
  ...
  return (
    ...
    <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <Link to="/" onClick={handleUpSc} class="hover:underline">Vega</Link>. All Rights Reserved.
    </span>
